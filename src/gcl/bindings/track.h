...
public:
    ...
    ///
    explicit Track(GrannyTransformTrack data);
...
protected:
    ...
    ///
    std::vector<CurvePositionKey> m_positionKeys;

    ///
    /// \brief Keys for the rotation curve of this track.
    ///
    std::vector<CurveRotationKey> m_rotationKeys;

    ///
    /// \brief Keys for the scale curve of this track.
    ///
    std::vector<CurveScaleKey> m_scaleKeys;
};
