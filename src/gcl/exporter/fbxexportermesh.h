...
public:
    ...
    ///
    void exportMeshes(const Bindings::Model::SharedPtr& model, bool exportSkeleton = false);
...
protected:
    ...
    ///
    static void createControlPoints(FbxMesh* mesh, std::vector<GrannyPWNT34322Vertex> vertices);
    ...
    /// \param vertices The vertices of the mesh.
    ///
    static void createNormal(FbxMesh* fbxMesh, const std::vector<GrannyPWNT34322Vertex>& vertices);
    ...
    ///
    int getMaterialForIndex(const Bindings::Mesh::SharedPtr& mesh, int index);
